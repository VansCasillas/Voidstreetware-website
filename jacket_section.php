...
<body class="relative">
    ...
    <main class="bg-gray-200">
        <section class="max-w-6xl mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden w-full mx-auto">
                ...
                <div class="relative overflow-hidden h-auto md:h-64">
                    <div id="carousel" class="flex transition-transform duration-500 ease-in-out h-full">
                        <?php
                        $jacket_carousel = mysqli_query($koneksi, "SELECT * FROM produk WHERE is_carousel_jacket = 1");
            ...
            <h2 class="text-2xl sm:text-3xl font-bold mb-6 mt-6">Jacket Collection</h2>
            ...
            <div id="custom-alert-container" class="fixed right-5 flex flex-col gap-2 z-50" style="top: 64px;">
            </div>
        </section>
