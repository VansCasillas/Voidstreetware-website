...
if (isset($_GET['action']) && $_GET['action'] == 'hapus') {
    ...
    echo "<script>alert('Produk Hoodie berhasil dihapus!'); window.location='produk_hoodie.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Produk Hoodie - Dashboard</title>
    ...
    <main class="flex-1 flex flex-col">
        ...
        <div class="bg-white py-4 shadow-sm">
            <div class="px-8 flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-800">Produk Hoodie</h1>
        ...
        <div class="flex-1 p-6">
            <!-- Tombol Tambah -->
            <div class="mb-4">
                <a href="?action=tambah" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-500 transition">
                    + Tambah Produk
                </a>
            </div>
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'tambah') { ?>
                <div class="bg-white shadow rounded p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4 text-gray-800">Form Tambah Produk Hoodie</h2>
                    <form method="post" enctype="multipart/form-data" class="space-y-4">
                        <div>
                            <label class="block mb-1 font-semibold">Nama Hoodie</label>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            <button type="submit" name="simpan" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-500 transition">Simpan</button>
                            <a href="produk_hoodie.php" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-300 transition">Batal</a>
                        </div>
                    </form>
                </div>
                <?php
                if (isset($_POST['simpan'])) {
                    ...
                    mysqli_query($koneksi, "INSERT INTO produk (nama_produk, harga, deskripsi, tumbnail_produk, kategori) 
                                VALUES ('$nama', '$harga', '$deskripsi', '$filename', 'hoodie')");
                    echo "<script>alert('Produk Hoodie berhasil ditambahkan!'); window.location='produk_hoodie.php';</script>";
                }
            }
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'ubah') {
                ...
                ?>
                <div class="bg-white shadow rounded p-6 mb-6">
                    <h2 class="text-xl font-bold mb-4 text-gray-800">Form Ubah Produk Hoodie</h2>
                    <form method="post" enctype="multipart/form-data" class="space-y-4">
                        <div>
                            <label class="block mb-1 font-semibold">Nama Hoodie</label>
                        ...
                        <div>
                            <label class="block mb-1 font-semibold">Deskripsi</label>
                            <textarea name="deskripsi" rows="3" class="w-full border rounded px-3 py-2" required><?= $produk['deskripsi']; ?></textarea>
                        </div>
                        <div>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            <button type="submit" name="update" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-500 transition">Update</button>
                            <a href="produk_hoodie.php" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-300 transition">Batal</a>
                        </div>
                    </form>
                </div>
            <?php
                if (isset($_POST['update'])) {
                    ...
                    echo "<script>alert('Produk Hoodie berhasil diubah!'); window.location='produk_hoodie.php';</script>";
                }
            }
            ?>
            ...
            <div class="mt-6 bg-white shadow rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-gray-800">Daftar Produk Hoodie</h2>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Nama Hoodie</th>
